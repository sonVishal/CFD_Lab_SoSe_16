...
Once the project is built, the scenario file needs to be set up. Open the \verb|project.dat| file inside the \verb|scenarios| folder with any text editor. This file already consists default values of the input parameters to the code. Following is a description of all the parameters:
\begin{itemize}
