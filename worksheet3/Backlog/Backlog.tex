...
\begin{enumerate}
\item \td{Group disussion: (see github issue \url{https://github.com/sonVishal/CFD_Lab_SoSe_16/issues/2})}
...
\item \td{Group discussion: (see github issue \url{https://github.com/sonVishal/CFD_Lab_SoSe_16/issues/2})}
